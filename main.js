...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://odin5/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://odin5/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://odin5/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://odin5/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://odin5/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("module.exports = __webpack_require__.p + \"45909ccd3b964b2cb143.avif\";\n\n//# sourceURL=webpack://odin5/./pattern.avif?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Pageload: () => (/* binding */ Pageload)\n/* harmony export */ });\n\nfunction Pageload(){\n    const contentdiv = document.getElementById(\"content\");\n    contentdiv.innerHTML=\" \";\n        const menudiv = document.createElement(\"div\");\n        const div1 = document.createElement(\"div\");\n        div1.textContent = \"Beary's breakfast Bar\";\n        div1.setAttribute(\"style\",\"font-size:40px;position:relative;left:5rem;\");\n        \n        const div2 = document.createElement(\"div\");\n        const p = document.createElement(\"p\");\n        p.textContent = `Beary's has the best porridge! The atmosphere and customer service make you feel like you are \n        sitting in the middle of the woods, eating like a bear! This is exactly the\n        kind of place that I like to return to again and again.`;\n        div2.setAttribute(\"style\",\"height:10rem; width:25rem; background-color:gold;position:relative; left:5rem; top:2rem;margin:1rem;padding:1rem;border-radius:50px;\");\n        div2.appendChild(p);\n        const div3 = document.createElement(\"div\");\n        div3.textContent = \"Hours\";\n        div3.setAttribute(\"style\",\"height:10rem; width:20rem; background-color:gold;position:relative; left:5rem; top:2rem;margin:1rem;padding:1rem;border-radius:50px;\");\n        const ul = document.createElement(\"ul\");\n        const items = [\"Sunday: 8am - 8pm\",\n\n            \"Monday: 6am - 6pm\",\n            \n            \"Tuesday: 6am - 6pm\",\n            \n            \"Wednesday: 6am - 6pm\",\n            \n            \"Thursday: 6am - 10pm\",\n            \n            \"Friday: 6am - 10pm\",\n            \n            \"Saturday: 8am - 10pm\"];\n        items.forEach(item=>{\n            let li = document.createElement(\"li\");\n            li.textContent = item;\n            ul.appendChild(li);\n        })\n        div3.appendChild(ul);\n        const div4 = document.createElement(\"div\");\n        div4.setAttribute(\"style\",\"height:5rem; width:20rem; background-color:gold;position:relative; left:5rem; top:2rem;margin:1rem;padding:1rem;border-radius:50px;\");\n        div4.textContent = \"Location:123 Forest Drive, Forestville, Maine\";\n        \n        menudiv.appendChild(div1);\n        menudiv.appendChild(div2);\n        menudiv.appendChild(div3);\n        menudiv.appendChild(div4);\n        contentdiv.appendChild(menudiv);\n}\n\n\n//# sourceURL=webpack://odin5/./src/pageload.js?");
